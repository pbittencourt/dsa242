...
\conferir{Isso não está de acordo com nosso estudo de caso, precisamos
entender!}
...
\conferir{Essa premissa também deve ser questionada em aula!}
...
\conferir{Não sabemos interpretar o que está acontecendo.}
...
positiva. Me parece que, para o \Cref{eg:coleta-precos}, tanto o segundo
coeficiente de Pearson quanto o coeficiente de assimetria de Fisher são os mais
adequados. \conferir{Confirmar se essa premissa é verdadeira.}
